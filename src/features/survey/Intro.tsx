...
const Image4 = () => {
  return (
    <svg width="255" height="284" viewBox="0 0 255 284" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="47" y="186" width="155" height="55" rx="1" fill="url(#paint1_linear_1652_38534)" fillOpacity="0.8" />
      ...
      <defs>
        ...
        >
          <stop stopColor="#D6E1FC" />
          <stop offset="1" stopColor="#F3F3FA" />
        </linearGradient>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#F1F4FA" />
          <stop offset="1" stopColor="#F3F7FC" stopOpacity="0" />
        </linearGradient>
      </defs>
    </svg>
  );
